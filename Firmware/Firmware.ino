...
//eeprom_update_word(&dataI_addr, dataI); //обновление данных
//eeprom_write_byte(&dataB_addr, dataB); //запись данных (даже если повтор)
//byte dataB_read = eeprom_read_byte(&dataB_addr);//чтение данных
...
void ADCinit(){ // Инициализация АЦП
  ...
  ads1220.set_pga_gain(PGA); //1,2,4,8,16,32,64,128
